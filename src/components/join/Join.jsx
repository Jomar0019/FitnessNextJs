    ...
    <div className="w-full h-[70vh]">
      <div className="relative w-full h-[70vh] mt-24">
        ...
        <div className="absolute inset-0 bg-red w-full h-full flex flex-col justify-center items-center mx-auto">
            <h1 className="text-white text-8xl font-bold">Join the Gymnastic Family</h1>
            <p className="my-12 text-white text-xl w-[900px] text-center leading-9">Gym session or brisk walk can help. Physical activity stimulates many brain chemicals that may leave you.</p>
            <div>
